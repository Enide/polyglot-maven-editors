...
import org.nodeclipse.enide.editors.pom.groovy.Activator;
import org.nodeclipse.enide.editors.pom.groovy.preferences.Constants;
...
//    private TextAttribute normalAttribute = new TextAttribute(EditorColors.getColor(new RGB(0, 0, 0)), null, SWT.NORMAL);
    ...
    private TextAttribute keywordAttribute = new TextAttribute(EditorColors.getColor(Constants.KEY_COLOR_KEYWORD), null, 
    		Activator.getDefault().getPreferenceStore().getBoolean(Constants.KEY_BOLD_KEYWORD) ? SWT.BOLD : SWT.NORMAL);
